          ...
          <div className="container">
            <div className="bookmarks-container">
              <div className="category-container">
                ...
                />
                <h2 className="heading mt-4 text-center">Categories</h2>
...
function filterByCategory(tweets, category) {
  if (category !== "ALL") {
    var filteredTweets = tweets.filter((tweet) => tweet.category === category);
...
function mapStateToProps(state) {
  return {
    ...
    tweets: filterByCategory(state.tweets.tweets, state.tweets.activeCategory),
  };
}
